    ...
    tracing_subscriber::registry()
        .with(
            tracing_subscriber::EnvFilter::try_from_default_env()
                .unwrap_or_else(|_| "axum_simple=debug,tower_http=info".into()),
        )
...
/// contains a PgPool to connect to the DB\
/// contains a flash_config needed by axum_flash
///
