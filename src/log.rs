...
/// Log layer, wrapping a service, logging its request and response.
#[derive(Debug, Clone)]
pub struct LogLayer;
...
/// Log service, wrapping another service, logging its requests and responses.
#[derive(Debug, Clone)]
    ...
    R: Debug,
{
    ...
    /// Same "shape" of the `Future` as the wrapped service, but dynamically typed boxed `Future`
